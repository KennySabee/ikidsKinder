  ...
  return (
    <div className="bg-yellow-50 py-16 md:py-24 relative">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <AnimatedSection>
          <h1 className="text-4xl md:text-5xl font-bold text-center text-yellow-700 mb-16">
            Proceso de Admisión
          </h1>
        </AnimatedSection>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-20">
          {admissionSteps.map((step, index) => (
            <AnimatedSection
              key={step.title}
              delay={`duration-[${300 + index * 100}ms]`}
            >
        ...
        <AnimatedSection>
          <div className="max-w-4xl mx-auto bg-white p-8 md:p-12 rounded-2xl shadow-lg border border-yellow-200">
            <h2 className="text-3xl md:text-4xl font-bold text-center text-yellow-700 mb-2">
                ...
                {submitStatus === "success" && (
                  <div className="p-4 bg-green-50 rounded-lg">
                    <p className="text-green-600 font-medium">
                      ¡Gracias! Hemos recibido tu solicitud. Te contactaremos
                      pronto.
                    </p>
                  </div>
                )}
